...
class addGroup(unittest.TestCase):
    ...
    def test_(self):
        ...
        self.groupForm(wd, _name=group_name, _logo=group_logo, _comment=group_comment)
        self.openMenu(wd, _tab=menu_tab)
        self.logout(wd)
    ...
    def groupForm(self, wd, _name, _logo, _comment):
        wd.find_element_by_name("new").click()
        wd.find_element_by_name("group_name").click()
        wd.find_element_by_name("group_name").clear()
        wd.find_element_by_name("group_name").send_keys(_name)
        wd.find_element_by_name("group_header").click()
        wd.find_element_by_name("group_header").clear()
        wd.find_element_by_name("group_header").send_keys(_logo)
        wd.find_element_by_name("group_footer").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys(_comment)
